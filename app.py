...
demo = gr.ChatInterface(
    ...
    description="This chatbot is a demo example for the dbdemos llm chatbot.<br> It is using DBRX, with an extra touch of Homer Simpson's quote at every answer.<br> Made with ❤️ by Yusuf Siregar.",
